...
Définissez un constructeur par défaut pour les classes `Voiture` et `Porte`, puis créer un objet de chaque classe et faire afficher chacun des attributs en console. Quelles sont les valeurs? Sont-elles les mêmes que précédemment (avec le constructeur autogénéré par le compilateur)?
